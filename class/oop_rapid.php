...
class User_rapid extends mysqli {
	...
	private function __construct() {
		$path 		= '../';
		$db_config  = 'db_config/db_rapid.php';
	...
	// 	// Corrected query to use dynamic username parameter
	// 	$select_query = $this->query("SELECT `email_add` FROM `tbl_useraccounts` WHERE `username` = '" . $this->real_escape_string($username) . "'");
	// 	return $select_query;
	// }
