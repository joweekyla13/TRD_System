...
<div class="wrapper">
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mt-4">
                            <div class="card-body">
                                <h3 class="fw-bold text-secondary">QC HEAD APPROVAL</h3>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-4">
                                        ...
                                        <p class="form-control" id="text_qc_approver_fullname" name="qc_approver_fullname" hidden><?php echo $username; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <p class="form-control" id="text_qc_approver_username" name="qc_approver_username" hidden><?php echo $username; ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btn_approve" name="btn_approve" class="btn btn-success btn_approve" data-bs-toggle="modal" data-bs-target=""><i class="fa-solid fa-check me-2" style="color: white"></i>APPROVE</button>
        ...
        <div class="modal fade" id="modalApproveRevisionRemarks" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formSubmitApproveRevisionRemarks" autocomplete="off">
                        <input type="hidden" id="hidden_approve_revision_conno" name="hidden_approve_revision_conno">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" name="approve_revision_remarks" id="text_approve_revision_remarks"></textarea>
                                <label for="text_approve_revision_remarks">Comments</label>
                            </div>

                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" id="btnAddApproveRemarks"><i class="fa-solid fa-file-import me-2" style="color: white"></i>Submit</button>
        ...
        <div class="modal fade" id="modalViewApproveRevisionRemarks" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-info">
                        <h1 class="modal-title fs-5 fw-bold" id="staticBackdropLabel">Revision Remarks</h1>
                    ...
                    <div class="modal-body">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" name="view_approve_revision_remarks" id="text_view_approve_revision_remarks" readonly></textarea>
                            <label for="text_view_approve_revision_remarks">Comments</label>
                        </div>
        ...
        <div class="modal fade" id="modalApproveDisapproveReason" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-info">
                    ...
                    <div class="modal-body">
                        <form id="formSubmitApproveDisapproveReason" autocomplete="off">
                            <input type="hidden" id="hidden_approve_disapprove_conno" name="hidden_approve_disapprove_conno">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" name="approve_disapprove_reason" id="text_approve_disapprove_reason"></textarea>
                                <label for="text_approve_disapprove_reason">Comments</label>
                            </div>

                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" id="btnAddApproveReason"><i class="fa-solid fa-file-import me-2" style="color: white"></i>Submit</button>
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa-solid fa-xmark me-2" style="color: white"></i>CLOSE</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="modalViewApproveDisapproveReason" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-info">
                        <h1 class="modal-title fs-5 fw-bold" id="staticBackdropLabel">Reason for Disapproval</h1>
                    ...
                    <div class="modal-body">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" name="view_approve_disapprove_reason" id="text_view_approve_disapprove_reason" readonly></textarea>
                            <label for="text_view_approve_disapprove_reason">Comments</label>
                        </div>
...
<script type="text/javascript">
    ...
    $('#qc_head_menu').each(function() {
        if (this.href === window.location.href) {
            ...
            $('#qc_head_tab').removeClass('d-none');
...
// });
    ...
    function initializeDataTable(tableId, status) {
        return $(tableId).DataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "./server_side_scripts/qc_head.php",
    ...
    $(document).on('click', '.btn_view', function () {
        ...
        let view_isHeadApproval = $(this).data('approval_status');
        console.log(view_isHeadApproval);

        if (view_isHeadApproval === 3 || view_isHeadApproval === 2 || view_isHeadApproval === 1) {
...
// ___________________________________________________________________________________________________________
    ...
    // EDITED 12-10-24
    let approver_username = $('#text_qc_approver_username').text();

    let getTRDSUserInfo = {
        "action": "get_trds_user_info",
        "userUsername": approver_username
    };
    $.ajax({
        type: "POST",
        url: handler,
        ...
        dataType: "json",
        success: function (response) {
            $("#text_qc_approver_fullname").text(response.EmpName);
    ...
    $(document).on('click', '.btn_approve', function () {
        let approve_conno = $('#view_text_conno').text();
        let approve_fullname = $("#text_qc_approver_fullname").text();

        console.log(approve_conno);

        let approve = {
            "action": "approve_req",
            "approve_conno": approve_conno,
            "approve_username": approver_username,
            "approve_fullname": approve_fullname
        };
    ...
    $('#modalApproveRevisionRemarks').on('hidden.bs.modal', function () {
        $('#formSubmitApproveRevisionRemarks')[0].reset();
    });

    $(document).on('click', '.btn_revision', function () {
        let revision_conno = $('#view_text_conno').text();
        $('#hidden_approve_revision_conno').val(revision_conno);
        $('#modalApproveRevisionRemarks').modal('show');
    });

    $(document).on('click', '.btnRevision', function () {
        let view_revision = $(this).data('revision_remarks');
        console.log(view_revision);
        $('#text_view_approve_revision_remarks').val(view_revision);
    });

    $('#formSubmitApproveRevisionRemarks').submit(function (e) { 
        e.preventDefault();

        let revision_conno = $('#hidden_approve_revision_conno').val();
        let revision_remarks = $('#text_approve_revision_remarks').val().trim();
        let approve_fullname = $("#text_qc_approver_fullname").text();

        let revision = {
            "action": "revision_approve_req",
            "approve_revision_conno": revision_conno,
            "approve_username": approver_username,
            "approve_fullname": approve_fullname
        };
        revision = $.param(revision) + "&" + $('#formSubmitApproveRevisionRemarks').serialize();
        ...
        if(!revision_remarks){
            ...
            success: function (response) {
                if (response.result) {
                    ...
                    $('#modalApproveRevisionRemarks').modal('hide');
                    // dataTablesConformance.draw();
                    // dataTablesReceiving.draw();
                    // dataTablesApproval.draw();
    ...
    // CLEARS FORM WHEN MODAL IS CLOSED
    $('#modalApproveDisapproveReason').on('hidden.bs.modal', function () {
        $('#formSubmitApproveDisapproveReason')[0].reset();
    });

    $(document).on('click', '.btn_disapprove', function () {
        let disapprove_conno = $('#view_text_conno').text();
        $('#hidden_approve_disapprove_conno').val(disapprove_conno);
        $('#modalApproveDisapproveReason').modal('show');
    });

    $(document).on('click', '.btnReason', function () {
        let view_reason = $(this).data('disapprove_reason');
        console.log(view_reason);
        $('#text_view_approve_disapprove_reason').val(view_reason);
    });

    $('#formSubmitApproveDisapproveReason').submit(function (e) { 
        e.preventDefault();

        let disapprove_conno = $('#hidden_approve_disapprove_conno').val();
        let disapprove_reason = $('#text_approve_disapprove_reason').val().trim();
        let approve_fullname = $("#text_qc_approver_fullname").text();

        let disapprove = {
            "action": "disapprove_approve_req",
            "approve_disapprove_conno": disapprove_conno,
            "approve_username": approver_username,
            "approve_fullname": approve_fullname
        };
        disapprove = $.param(disapprove) + "&" + $('#formSubmitApproveDisapproveReason').serialize();
        ...
        if(!disapprove_reason){
            ...
            success: function (response) {
                if (response.result) {
                    ...
                    $('#modalApproveDisapproveReason').modal('hide');
                    // dataTablesConformance.draw();
                    // dataTablesReceiving.draw();
                    // dataTablesApproval.draw();
