...
<div class="wrapper">
    ...
    <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mt-4">
                            <div class="card-body">
                                <h3 class="fw-bold text-secondary">Receiving</h3>
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#for_approval" type="button" role="tab" aria-selected="true">For Receiving</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <!-- Edited 1-20-25 -->
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#approved" type="button" role="tab" aria-selected="false">Received</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <!-- Edited 1-20-25 -->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="input-group-text text-light" style="background-color: DodgerBlue; width: 35%;">Section Head</span>
                                        ...
                                        <p class="form-control" style="display: none;" id="rec_text_email" name="rec_email"></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-4">
                                        <span class="input-group-text text-light" style="background-color: DodgerBlue; width: 35%;" hidden>Receiver Full Name</span>
                                        <p class="form-control" id="rec_text_receiver_fullname" name="rec_receiver_fullname" hidden><?php echo $username; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    
                                    <div class="input-group mb-4">
                                        <span class="input-group-text text-light" style="background-color: DodgerBlue; width: 35%;" hidden>Receiver Username</span>
                                        <p class="form-control" id="rec_text_receiver_username" name="rec_receiver_username" hidden><?php echo $username; ?></p>
                                    </div>
                                </div>
                            </div>

                            <div class="modal-footer">
                                <!-- <button type="button" id="btn_revision" name="btn_revision" class="btn btn-warning btn_revision" data-bs-toggle="modal" data-bs-target="#modalReceivingRevisionRemarks"><i class="fa-solid fa-arrow-rotate-left me-2" style="color: white"></i>FOR REVISION</button>
                                <button type="button" id="btn_disapprove" name="btn_disapprove" class="btn btn-danger btn_disapprove" data-bs-toggle="modal" data-bs-target=""><i class="fa-solid fa-xmark me-2" style="color: white"></i>DISAPPROVE</button>
                                ...
                                <!-- Edited 1-20-25 -->
                                <button type="button" id="btn_revision" name="btn_revision" class="btn btn-danger btn_revision" data-bs-toggle="modal" data-bs-target="#modalReceivingRevisionRemarks"><i class="fa-solid fa-arrow-rotate-left me-2" style="color: white"></i>DISAPPROVE</button>
                                <button type="button" class="btn btn-dark" data-bs-dismiss="modal"><i class="fa-solid fa-xmark me-2" style="color: white"></i>CLOSE</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="modalReceivingRevisionRemarks" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formSubmitReceivingRevisionRemarks" autocomplete="off">
                        <input type="hidden" id="hidden_receiving_revision_conno" name="hidden_receiving_revision_conno">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" name="receiving_revision_remarks" id="text_receiving_revision_remarks"></textarea>
                                <label for="text_receiving_revision_remarks">Comments</label>
                            </div>
        ...
        <div class="modal fade" id="modalViewReceivingRevisionRemarks" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-info">
                        <h1 class="modal-title fs-5 fw-bold" id="staticBackdropLabel">Revision Remarks</h1>
                    ...
                    <div class="modal-body">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" name="view_receiving_revision_remarks" id="text_view_receiving_revision_remarks" readonly></textarea>
                            <label for="text_view_receiving_revision_remarks">Comments</label>
                        </div>
        ...
        <div class="modal fade" id="modalReceivingDisapproveReason" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-info">
                    ...
                    <div class="modal-body">
                        <form id="formSubmitReceivingDisapproveReason" autocomplete="off">
                            <input type="hidden" id="hidden_receiving_disapprove_conno" name="hidden_receiving_disapprove_conno">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" name="receiving_disapprove_reason" id="text_receiving_disapprove_reason"></textarea>
                                <label for="text_receiving_disapprove_reason">Comments</label>
                            </div>

                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" id="btnAddReceivingReason"><i class="fa-solid fa-file-import me-2" style="color: white"></i>Submit</button>
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa-solid fa-xmark me-2" style="color: white"></i>CLOSE</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="modalViewReceivingDisapproveReason" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-info">
                        <h1 class="modal-title fs-5 fw-bold" id="staticBackdropLabel">Reason for Disapproval</h1>
                    ...
                    <div class="modal-body">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" name="view_receiving_disapprove_reason" id="text_view_receiving_disapprove_reason" readonly></textarea>
                            <label for="text_view_receiving_disapprove_reason">Comments</label>
                        </div>
...
<script type="text/javascript">
    ...
    $('#receiving_menu').each(function() {
        if (this.href === window.location.href) {
            ...
            $('#receiving_tab').removeClass('d-none');
    ...
    $('#btnSubmitMemo').on('click', function() {
        if (window.employeeDataArray && window.employeeDataArray.length > 0) {
            ...
            toastr.success('Trainees successfully added!');
...
$(document).on('click', '.btn_view', function () {
    ...
    $(document).on('click', '.btn_Rview', function () {
        ...
        console.log(view_isReceived);

        if (view_isReceived === 3 || view_isReceived === 2 || view_isReceived === 1) {
            $('#btn_revision').addClass('d-none');
            $('#btn_disapprove').addClass('d-none');
            $('#btn_received').addClass('d-none');
        } else {
            $('#btn_revision').removeClass('d-none');
            $('#btn_disapprove').removeClass('d-none');
            $('#btn_received').removeClass('d-none');
        }
    ...
    // INEDIT 12-10-24
    let receiver_username = $('#rec_text_receiver_username').text();

    let getTRDSUserInfo = {
        "action": "get_trds_user_info",
        "userUsername": receiver_username
    };
    $.ajax({
        type: "POST",
        url: handler,
        ...
        dataType: "json",
        success: function (response) {
            $("#rec_text_receiver_fullname").text(response.EmpName);
    ...
    $(document).on('click', '.btn_received', function () {
        ...
        let receiver_fullname = $('#rec_text_receiver_fullname').text();
    ...
    $('#modalReceivingRevisionRemarks').on('hidden.bs.modal', function () {
        $('#formSubmitReceivingRevisionRemarks')[0].reset();
    });

    $(document).on('click', '.btn_revision', function () {
        let revision_conno = $('#rec_text_conno').text();
        $('#hidden_receiving_revision_conno').val(revision_conno);
    ...
    $(document).on('click', '.btnRevision', function () {
        ...
        $('#text_view_receiving_revision_remarks').val(view_revision);
    });

    $('#formSubmitReceivingRevisionRemarks').submit(function (e) { 
        e.preventDefault();

        let revision_conno = $('#hidden_receiving_revision_conno').val();
        let revision_remarks = $('#text_receiving_revision_remarks').val().trim();
        let receiver_fullname = $('#rec_text_receiver_fullname').text();


        let revision = {
            "action": "revision_receive_req",
            "receiver_username": receiver_username,
            "receiver_fullname": receiver_fullname,
            "receiving_revision_conno": revision_conno
        };
        revision = $.param(revision) + "&" + $('#formSubmitReceivingRevisionRemarks').serialize();
        ...
        if(!revision_remarks){
            ...
            success: function (response) {
                if (response.result) {
                    ...
                    $('#modalReceivingRevisionRemarks').modal('hide');
                    // dataTablesConformance.draw();
                    // dataTablesReceiving.draw();
                    // dataTablesApproval.draw();
    ...
    // CLEARS FORM WHEN MODAL IS CLOSED
    $('#modalReceivingDisapproveReason').on('hidden.bs.modal', function () {
        $('#formSubmitReceivingDisapproveReason')[0].reset();
    });

    $(document).on('click', '.btn_disapprove', function () {
        let disapprove_conno = $('#rec_text_conno').text();
        $('#hidden_receiving_disapprove_conno').val(disapprove_conno);
        $('#modalReceivingDisapproveReason').modal('show');
    });

    $(document).on('click', '.btnReason', function () {
        let view_reason = $(this).data('disapprove_reason');
        console.log(view_reason);
        $('#text_view_receiving_disapprove_reason').val(view_reason);
    });

    // EDITED 12-10-24
    $('#formSubmitReceivingDisapproveReason').submit(function (e) { 
        e.preventDefault();

        let disapprove_conno = $('#hidden_receiving_disapprove_conno').val();
        let disapprove_reason = $('#text_receiving_disapprove_reason').val().trim();
        let receiver_fullname = $('#rec_text_receiver_fullname').text();

        let disapprove = {
            "action": "disapprove_receive_req",
            "receiver_username": receiver_username,
            "receiver_fullname": receiver_fullname,
            "receiving_disapprove_conno": disapprove_conno
        };
        disapprove = $.param(disapprove) + "&" + $('#formSubmitReceivingDisapproveReason').serialize();
        ...
        if(!disapprove_reason){
            ...
            success: function (response) {
                if (response.result) {
                    ...
                    $('#modalReceivingDisapproveReason').modal('hide');
                    // dataTablesConformance.draw();
                    // dataTablesReceiving.draw();
                    // dataTablesApproval.draw();
