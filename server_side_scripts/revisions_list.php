<?php
	...
	$aColumns = array('pkid', 'date_time_created', 'exam_category', 'exam_title', 'exam_revision_no','exam_purpose','exam_department','exam_position','exam_remarks','exam_passing_score','exam_status','logdel', 'exam_productLine');
	...
	*/
	...
	// $sWhere .= " logdel=0 AND exam_purpose = '".$_SESSION['getPurpose']."' AND exam_position = '".$_SESSION['getPosition']."'";
	$sWhere .= " logdel=0 AND exam_title = '".$_SESSION['getTitle']."'";
	
	if($sOrder == ""){
		$sOrder = 'ORDER BY exam_status ASC';
	}
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		$row[]  = '<center>
           <button type="button" 
                   ...
                   class="btn btn-info fa-solid fa-eye btn_exam_view"
				   title="View exam"
				   style="color:white"
                   id="btn_view" 
                   value="'.$aRow['pkid'].'" 
           ...
           <a
                class="btn btn-warning fa-solid fa-list-ul btn_r_questions_list" 
				...
				value="'.$aRow['pkid'].'" 
		   		...
		   		// href="index.php?page=revisions_questions.php&pkid='.$aRow['pkid'].'"
