	...
	*/
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
        ...
        if ($aRow['isHeadApproval'] == 0) {
            ...
            $row[] = '<center><span class="badge bg-success text-light"><span>Approved<br><span> by: '. $aRow['qc_head_approver'] .'</span></span></span><br><i style="font-size: 0.8em;">'.$aRow['approved_at'].'</i></center>';
		...
		if($aRow['isHeadApproval'] == 0) {
			...
			<button type="button" 
				...
				data-approval_status="'.$aRow['isHeadApproval'].'" 

				>
			</button>';
		}
		elseif($aRow['isHeadApproval'] == 1 || $aRow['isHeadApproval'] == 2 || $aRow['isHeadApproval'] == 3) {
			$row[]  = '<center>
			<button type="button" 
				data-bs-toggle="modal" 
				data-bs-target="#viewTraineeModal" 
		...
		// 		data-bs-toggle="modal" 
		// 		data-bs-target="#viewTraineeModal" 
		// 		class="btn btn-info fa-solid fa-pen-to-square btn_view" 
		// 		style="color:white"
		// 		id="btn_view" 
		// 		value="'.$aRow['pkid'].'" 
