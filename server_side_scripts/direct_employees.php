<?php
	...
	$database_config = '../db_config/db_hris.php';
	...
	*/
	...
	$sQuery = "
		...
		FROM $sTable
		INNER JOIN tbl_Position ON tbl_Position.pkid = tbl_EmployeeInfo.fkPosition
        INNER JOIN tbl_Section ON tbl_Section.pkid = tbl_EmployeeInfo.fkSection
        $sWhere
		$sOrder
		$sLimit
	";
