<?php
	...
	$aColumns = array('pkid','question_number','exam_pkid','question_type','question_image_path', 'question_desc','question','question_choices','question_answer','question_points','question_status', 'logdel');
	...
	*/
	...
	$sWhere .= " question_status IN (0, 1) AND exam_pkid = '".$_SESSION['question_pkid']."' ";
